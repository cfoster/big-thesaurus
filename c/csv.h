...
int csv_fini(struct csv_parser *p, void (*cb1)(char *, size_t), void (*cb2)(char));
void csv_free(struct csv_parser *p);
int csv_error(struct csv_parser *p);
char * csv_strerror(int error);
size_t csv_parse(struct csv_parser *p, const char *s, size_t len, void (*cb1)(char *, size_t), void (*cb2)(char));
