...
Copyright (C) 2006  Robert Gamble
...
int
csv_fini(struct csv_parser *p, void (*cb1)(char *, size_t), void (*cb2)(char c))
{
...
size_t
csv_parse(struct csv_parser *p, const char *s, size_t len, void (*cb1)(char *, size_t), void (*cb2)(char c))
{
